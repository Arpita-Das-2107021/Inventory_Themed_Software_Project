...
- **Employees** can access sales views for their shop.
...
| User <-> Shop (manager assignment)  | M : M       | `shop_managers`                 |
| User <-> Shop (employee assignment) | M : M       | `shop_employees`                |
...
- Graceful MVC error page rendering via global exception handler.
...
| Create Sales      | No                 | Yes                                | No                        |
| Manage Products   | No                 | Yes (assigned shop)                | Yes (organization shops)  |
| Manage Categories | No                 | Yes                                | Yes                       |
| Manage Shops      | No                 | Limited (employee assignment only) | Yes                       |
| Manage Users      | Limited            | Limited                            | Full                      |
...
| Method | Path                    | Access                           | Description     |
| ------ | ----------------------- | -------------------------------- | --------------- |
| GET    | `/categories`           | SHOP_MANAGER, ORGANIZATION_ADMIN | Category list   |
| GET    | `/categories/new`       | SHOP_MANAGER, ORGANIZATION_ADMIN | Create form     |
| POST   | `/categories`           | SHOP_MANAGER, ORGANIZATION_ADMIN | Create category |
| GET    | `/categories/{id}/edit` | SHOP_MANAGER, ORGANIZATION_ADMIN | Edit form       |
| PUT    | `/categories/{id}`      | SHOP_MANAGER, ORGANIZATION_ADMIN | Update category |
| DELETE | `/categories/{id}`      | SHOP_MANAGER, ORGANIZATION_ADMIN | Delete category |

### Product Management

| Method | Path                   | Access                           | Description            |
| ------ | ---------------------- | -------------------------------- | ---------------------- |
| GET    | `/products`            | SHOP_MANAGER, ORGANIZATION_ADMIN | Product list (+search) |
| GET    | `/products/new`        | SHOP_MANAGER, ORGANIZATION_ADMIN | Create form            |
| POST   | `/products`            | SHOP_MANAGER, ORGANIZATION_ADMIN | Create product         |
| GET    | `/products/{id}/edit`  | SHOP_MANAGER, ORGANIZATION_ADMIN | Edit form              |
| PUT    | `/products/{id}`       | SHOP_MANAGER, ORGANIZATION_ADMIN | Update product         |
| DELETE | `/products/{id}`       | SHOP_MANAGER, ORGANIZATION_ADMIN | Soft delete product    |
| GET    | `/products/{id}/stock` | SHOP_MANAGER, ORGANIZATION_ADMIN | Stock adjustment form  |
| PATCH  | `/products/{id}/stock` | SHOP_MANAGER, ORGANIZATION_ADMIN | Apply stock adjustment |
...
| GET    | `/sales/new`          | SHOP_MANAGER                               | New sale form         |
| POST   | `/sales`              | SHOP_MANAGER                               | Create sale + invoice |
